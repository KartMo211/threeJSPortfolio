...
const DemoComputer = (props) => {
  ...
  //this is used to load the video texture for the computer screen
  const txt = useVideoTexture(props.texture ? props.texture : '/textures/project/project1.mp4');

  //this is used to flip the texture on the computer screen
  useEffect(() => {
    if (txt) {
      txt.flipY = false;
    }
  ...
  // animating the computer so that it has the rotation effect
  useGSAP(() => {

...
//float -> it gives the floating effect to the logo
        //floatIntensity -> it is used to control the intensity of the floating effect
//group -> it is used to group the mesh and apply the same transformation to all the children
